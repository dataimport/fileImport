...
public class MongoSolrTask extends BaseTask{
	...
	public MongoSolrTask(){
		super();
	}
	public MongoSolrTask(String uid, String tableName, String tableNameAlias, String origin, String catelog,
